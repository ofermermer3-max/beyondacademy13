...
class _Chat2InviteUsersWidgetState extends State<Chat2InviteUsersWidget> {
  ...
  void initState() {
    ...
    _model.textController ??=
        TextEditingController(text: widget!.chatRef?.chatName);
          ...
          actions: [
            Padding(
              ...
              child: FlutterFlowIconButton(
                borderRadius: 12.0,
                borderWidth: 1.0,
                buttonSize: MediaQuery.sizeOf(context).width < kBreakpointSmall
                    ? 44.0
                    : 52.0,
                        ...
                        pagingController: _model.setListViewController(
                          UsersRecord.collection
                              .where(Filter.or(
                                ...
                                Filter(
                                  'role',
                                  isEqualTo: Role.parent.serialize(),
                                ),
                              ))
