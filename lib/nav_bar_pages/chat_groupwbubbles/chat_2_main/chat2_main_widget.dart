...
class _Chat2MainWidgetState extends State<Chat2MainWidget> {
  ...
  void initState() {
    ...
    _model.searchChatsTextController ??= TextEditingController();
    _model.searchChatsFocusNode ??= FocusNode();
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(30.0, 20.0, 0.0, 15.0),
                child: Container(
                  width: MediaQuery.sizeOf(context).width < kBreakpointSmall
                      ? 200.0
                      : 400.0,
                  child: TextFormField(
                    controller: _model.searchChatsTextController,
                    focusNode: _model.searchChatsFocusNode,
                    onChanged: (_) => EasyDebounce.debounce(
                      '_model.searchChatsTextController',
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon:
                          _model.searchChatsTextController!.text.isNotEmpty
                              ? InkWell(
                                  onTap: () async {
                                    _model.searchChatsTextController?.clear();
                                    safeSetState(() {});
                                  },
                                  child: Icon(
                                    Icons.clear,
                    ...
                    validator: _model.searchChatsTextControllerValidator
                        .asValidator(context),
                  ),
                ),
              ),
                    ...
                    noItemsFoundIndicatorBuilder: (_) => Center(
                      child: Container(
                        ...
                        child: EmptyStateSimpleWidget(
                          ...
                          title: 'אין צ\'אטים',
                          body:
                              'אין לך צ\'אטים זמינים, התחל צ\'אט חדש על ידי לחיצה בצד שמאל למעלה',
                        ),
                      ),
                    ),
                      ...
                      return FutureBuilder<UsersRecord>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return Container(
                            ...
                            child: Visibility(
                              visible: (listViewChatsRecord.users.length <= 2
                                      ? containerUsersRecord.displayName
                                      : listViewChatsRecord.chatName)
                                  .contains(
                                      _model.searchChatsTextController.text),
                              child: Padding(
