...
class _EditProfileComponentWidgetState
  ...
  void initState() {
    ...
    _model.yourTeamTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.team, ''));
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: CachedNetworkImage(
                              ...
                              fadeOutDuration: Duration(milliseconds: 200),
                              imageUrl:
                                  _model.uploadedFileUrl_uploadDatacomponet,
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    if (selectedMedia != null &&
                      ...
                      safeSetState(() =>
                          _model.isDataUploading_uploadDatacomponet = true);
                      ...
                      try {
                        ...
                        _model.isDataUploading_uploadDatacomponet = false;
                      }
                      if (selectedUploadedFiles.length ==
                              selectedMedia.length &&
                          downloadUrls.length == selectedMedia.length) {
                        safeSetState(() {
                          _model.uploadedLocalFile_uploadDatacomponet =
            ...
            if (widget!.role == Role.player)
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 12.0),
                child: AuthUserStreamWidget(
                  builder: (context) => TextFormField(
                    controller: _model.yourTeamTextController,
                    ...
                    cursorColor: FlutterFlowTheme.of(context).primary,
                    validator: _model.yourTeamTextControllerValidator
                        .asValidator(context),
                    inputFormatters: [
                      if (!isAndroid && !isiOS)
                        TextInputFormatter.withFunction((oldValue, newValue) {
              ...
              Padding(
                ...
                child: AuthUserStreamWidget(
                  builder: (context) => FlutterFlowDropDown<String>(
                    controller: _model.ageLevelValueController ??=
                        FormFieldController<String>(
                      _model.ageLevelValue ??=
                          valueOrDefault(currentUserDocument?.playingLevel, ''),
                    ),
                    options: [
                      'קטסל ב',
                      'קטסל א',
                    ...
                    onChanged: (val) =>
                        safeSetState(() => _model.ageLevelValue = val),
                  ...
                  children: [
                    AuthUserStreamWidget(
                      builder: (context) => Theme(
                        ...
                        child: Checkbox(
                          value: _model.permissionCheckboxValue ??=
                              valueOrDefault<bool>(
                                  currentUserDocument?.detailsPermission,
                                  false),
                          onChanged: (newValue) async {
                            safeSetState(() =>
                                _model.permissionCheckboxValue = newValue!);
                          },
                  ...
                  onPressed: () async {
                    ...
                    if (widget!.role == Role.player) {
                      ...
                      await currentUserReference!.update(createUsersRecordData(
                        ...
                        photoUrl: _model.uploadedFileUrl_uploadDatacomponet !=
                                    null &&
                                _model.uploadedFileUrl_uploadDatacomponet != ''
                            ? _model.uploadedFileUrl_uploadDatacomponet
                            : currentUserPhoto,
                        team: _model.yourTeamTextController.text,
                        city: _model.yourCityTextController.text,
                        playingLevel: _model.ageLevelValue,
                        detailsPermission: _model.permissionCheckboxValue,
                      ));
                    } else if (widget!.role == Role.parent) {
                      // updateUserInfo
